...
export async function deleteQurban(id) {
    try {
        const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL_LOCAL}/qurban?id=${id}`, {
            method: 'DELETE'
        });
        const data = await res.json();
        return data;
...
export async function deleteBuyer(id) {
    try {
        const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL_LOCAL}/buyer?id=${id}`, {
            method: 'DELETE'
        });
        const data = await res.json();
        return data;
...
export async function deleteTypeQurban(id) {
    try {
        const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL_LOCAL}/qurban/type?id=${id}`, {
            method: 'DELETE'
        });
        const data = await res.json();
        return data;
...
export async function postLogin(body) {
    try {
        const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL_LOCAL}/auth/signin`, {
            method: 'POST',
            body: body,
            credentials: 'include',
            headers: {
